...
const socialLinks = [
  {
    name: 'Facebook',
    url: 'https://www.facebook.com/dhakaintoriordesign/',
    icon: (
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-center gap-2">
              ...
              <span className="opacity-80">+8801334-003388</span>
            </li>
            <li className="flex items-center gap-2">
            ...
            <li className="flex items-start gap-2">
              ...
              <span className="opacity-80">67, Indira Road, West Raja Bazar, Dhaka, Bangladesh, 1215
              </span>
            </li>
          </ul>
          <Link
